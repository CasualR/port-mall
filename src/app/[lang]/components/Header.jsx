    ...
    return (
        <header className='header'>
            <a href='#' className="header__logo">
                <Image src='/images/header_logo.svg' alt='' width={178} height={24} />
            </a>
            <div className='header__menu'>
                <a href="#" className="burger__logo">
                    <Image src='/images/burger_logo.svg' alt='' width={74} height={13} />
                </a>
                <ul className="header__list">
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink1}</a>
                    </li>
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink2}</a>
                    </li>
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink3}</a>
                    </li>
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink4}</a>
                    </li>
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink5}</a>
                    </li>
                    <li>
                        <a href="#" className="header__link">{lang.header.menuLink6}</a>
                    </li>
                </ul>
                <div className="header__right">
                    <ChangeLanguage passedValue={props.passedValue} />
